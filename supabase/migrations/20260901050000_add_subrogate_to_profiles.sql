-- Add subrogate_id and is_subrogating columns to profiles
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS subrogate_id UUID REFERENCES public.profiles(id) ON DELETE SET NULL,
ADD COLUMN IF NOT EXISTS is_subrogating BOOLEAN DEFAULT FALSE;

-- Update trigger function to include active subrogates in notifications
